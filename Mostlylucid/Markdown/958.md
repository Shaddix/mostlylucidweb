...
Anyway, presented below is a modified version of that class (which I've also tried out my new formatting scheme on) as a reminder, it's just a simple wrapper around [SharpZipLib](http://www.icsharpcode.net/OpenSource/SharpZipLib/Default.aspx).
