...
public class SignalBasedCircuitBreaker
{
    ...
    /// <summary>
    /// Create a new signal-based circuit breaker.
    /// </summary>
    /// <param name="failureSignal">Signal name that indicates a failure (default: "failure").</param>
    /// <param name="threshold">Number of failures before circuit opens (default: 5).</param>
    /// <param name="windowSize">Time window to count failures (default: 30 seconds).</param>
