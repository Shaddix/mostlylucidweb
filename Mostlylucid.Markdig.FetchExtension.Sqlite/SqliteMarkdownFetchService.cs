...
/// <summary>
///     SQLite-based implementation of IMarkdownFetchService.
///     Caches fetched markdown to SQLite database for persistence across restarts.
/// </summary>
public class SqliteMarkdownFetchService : IMarkdownFetchService
{
    private readonly MarkdownCacheDbContext _dbContext;
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly ILogger<SqliteMarkdownFetchService> _logger;

    public SqliteMarkdownFetchService(
        MarkdownCacheDbContext dbContext,
        IHttpClientFactory httpClientFactory,
        ILogger<SqliteMarkdownFetchService> logger)
    {
