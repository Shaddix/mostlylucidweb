...
/// <summary>
///     SQL Server-based implementation of IMarkdownFetchService.
///     Caches fetched markdown to SQL Server database for persistence across restarts.
/// </summary>
public class SqlServerMarkdownFetchService : IMarkdownFetchService
{
    private readonly MarkdownCacheDbContext _dbContext;
    private readonly IHttpClientFactory _httpClientFactory;
    private readonly ILogger<SqlServerMarkdownFetchService> _logger;

    public SqlServerMarkdownFetchService(
        MarkdownCacheDbContext dbContext,
        IHttpClientFactory httpClientFactory,
        ILogger<SqlServerMarkdownFetchService> logger)
    {
