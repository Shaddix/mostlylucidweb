...
public static class BotListSources
{
    ...
    /// </summary>
    public const string MatomoBotList = "https://raw.githubusercontent.com/matomo-org/device-detector/master/regexes/bots.yml";

    /// <summary>
    /// Crawler User Agents (JSON format)
    /// Community-maintained list of known crawlers
    /// </summary>
    public const string CrawlerUserAgents = "https://raw.githubusercontent.com/monperrus/crawler-user-agents/master/crawler-user-agents.json";
