...
public class GeoRoutingOptions
{
    ...
    /// </summary>
    public Func<Microsoft.AspNetCore.Http.HttpContext, GeoBlockResult, Task>? OnBlocked { get; set; }

    /// <summary>
    /// Custom action when a request is routed
    /// </summary>
    public Func<Microsoft.AspNetCore.Http.HttpContext, GeoLocation, Task>? OnRouted { get; set; }
}
