...
This repository contains the source code for mostlylucid — the personal site and blog of Scott Galloway, a consulting web developer and systems architect with over 30 years of experience building web applications.
...
Technical deep dives into ASP.NET Core, JavaScript frameworks (HTMX, Alpine.js, etc.), Docker, cloud, and search technologies.
...
git clone https://github.com/<your-username>/mostlylucidweb.git
cd mostlylucidweb
npm install
dotnet restore
...
Systems architecture and rapid prototyping

Remote team leadership and startup bootstrapping

If you’d like to collaborate, consult, or just chat about building things:
 scott.galloway+ml@gmail.com
