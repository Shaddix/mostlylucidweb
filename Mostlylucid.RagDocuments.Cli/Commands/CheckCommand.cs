...
using Mostlylucid.RagDocuments.Cli.Services;
using Mostlylucid.RagDocuments.Data;
using Spectre.Console;

namespace Mostlylucid.RagDocuments.Cli.Commands;
    ...
    public static Command Create()
    {
        ...
        command.SetAction(async (parseResult, ct) =>
        {
            ...
            if (dbExists)
            {
                ...
                var completedCount = await db.Documents.CountAsync(d => d.Status == Mostlylucid.RagDocuments.Entities.DocumentStatus.Completed, ct);
                var segmentCount = await db.Documents.Where(d => d.Status == Mostlylucid.RagDocuments.Entities.DocumentStatus.Completed).SumAsync(d => d.SegmentCount, ct);
